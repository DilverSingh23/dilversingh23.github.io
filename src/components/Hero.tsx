...
export default function Hero() {
    return (
        <div className="min-h-screen w-full flex flex-col overflow-hidden bg-[url('hero/hero-bg.jpg')] bg-center bg-cover">
            <div className="flex flex-col flex-1 gap-12 justify-center items-center h-full w-full pt-16 h-[700px]:flex text-gray-300 font-inter">
                ...
                <h1 className="text-5xl sm:text-6xl font-thin tracking-widest">Dilver Singh</h1>
